...
for dataset in pr; do
  for augmentation in Affine CLAHE GaussianBlur GridDistortion ISONoise    MotionBlur RandomGamma Blur GaussNoise HueSaturationValue MedianBlur OpticalDistortion  RandomRotate90 Transpose cut_mix; do
    for color in RGB; do
      for min in "20"; do
        for size in "256" "400" "512"; do
          for model in "vgg16"; do
